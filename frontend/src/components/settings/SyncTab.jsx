...
export default function SyncTab() {
  ...
  const dynamicCrmExportFields = [
    ...
    { key: 'entered_l2_ucmas_at', label: 'Thời điểm lên L2 UCMAS', defaultHeader: 'Mốc L2 UCMAS' },
    { key: 'entered_l2_uckid_at', label: 'Thời điểm lên L2 UCKID', defaultHeader: 'Mốc L2 UCKID' },
    { key: 'entered_l3_ucmas_at', label: 'Thời điểm lên L3 UCMAS', defaultHeader: 'Mốc L3 UCMAS' },
    { key: 'entered_l3_uckid_at', label: 'Thời điểm lên L3 UCKID', defaultHeader: 'Mốc L3 UCKID' },
