-- ============================================================
-- MIGRATION: Outbound sync additional fields (l4_type and L1-L4 milestones)
-- Chạy file này trên Supabase SQL Editor
-- ============================================================

-- 1. Drop hàm cũ vì có sự thay đổi cấu trúc bảng trả về (RETURNS TABLE)
DROP FUNCTION IF EXISTS rpc_get_leads_for_outbound_sync(TIMESTAMPTZ);

-- 2. Định nghĩa lại hàm với các cột mới
