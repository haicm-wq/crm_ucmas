...
CREATE INDEX IF NOT EXISTS idx_leads_non_l0_created
...
CREATE INDEX IF NOT EXISTS idx_llh_lead_created_desc
...
CREATE INDEX IF NOT EXISTS idx_leads_trial_appt_not_null
